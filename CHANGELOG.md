...
* [k8s.io/apimachinery] `unstructued.Unstructured` got getters and setters
...
* [k8s.io/code-generator] `+groupName`tag added to allow unique Go identifiers in clientsets and informers
