...
If your application runs in a Pod in the cluster, please refer to the in-cluster [example](examples/in-cluster-client-configuration/main.go), otherwise please refer to the out-of-cluster [example](examples/out-of-cluster/main.go).
